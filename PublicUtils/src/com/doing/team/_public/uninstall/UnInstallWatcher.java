        ...
        new Thread() {
            ...
            public void run() {
              //  tryStart2(context, pageurl, counturl);
               ...
               /* try {
                    Process process2 = Runtime.getRuntime().exec("chmod 755 " + watcher);
                    process2.waitFor();
                } catch (Throwable e) {
                    e.printStackTrace();
                }*/
                try {
                    ...
                    if (!status.equals(Environment.MEDIA_MOUNTED)) {
                    	work_dir = context.getApplicationInfo().dataDir + "/360around/watcher/work";
                    }else{
                    	work_dir = Environment.getExternalStorageDirectory() + "/mAround/watcher/work";
                    }
