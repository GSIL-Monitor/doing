...
import com.doing.team.pulltorefresh.internal.LoadingLayout;
import com.doing.team.pulltorefresh.internal.RotateLoadingLayout;
import com.doing.team.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START, null);
		mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END, null);
