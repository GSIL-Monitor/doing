...
public class StatusesAPI extends AbsOpenAPI {
     ...
     *            访问令牌
     */
    public StatusesAPI(Context context, Oauth2AccessToken accessToken) {
     ...
     *            异步请求回调接口
     */
    public void mentions(long since_id, long max_id, int count, int page, int authorType,
            int sourceType, int filterType, boolean trim_user, RequestListener listener) {
        WeiboParameters params = buildMentionsParams(since_id, max_id, count, page, authorType,
                sourceType, filterType, trim_user);
     ...
     *            异步请求回调接口
     */
    public void uploadUrlText(String status, String imageUrl, String pic_id, String lat,
     ...
     */
    public String friendsTimelineSync(long since_id, long max_id, int count, int page,
     ...
     *      com.sina.weibo.sdk.net.RequestListener)
     */
    public String mentionsSync(long since_id, long max_id, int count, int page, int authorType,
            int sourceType, int filterType, boolean trim_user) {
        WeiboParameters params = buildMentionsParams(since_id, max_id, count, page, authorType,
                sourceType, filterType, trim_user);
    ...
    /**
     * @see #upload(String, android.graphics.Bitmap, String, String,
     *      com.sina.weibo.sdk.net.RequestListener)
     */
     ...
     *      com.sina.weibo.sdk.net.RequestListener)
     */
    public String uploadUrlTextSync(String status, String imageUrl, String pic_id, String lat,
            String lon) {
        WeiboParameters params = buildUpdateParams(status, lat, lon);
        params.put("url", imageUrl);
        params.put("pic_id", pic_id);
    ...
    // 组装TimeLines的参数
    private WeiboParameters buildTimeLineParamsBase(long since_id, long max_id, int count,
            int page, boolean base_app, boolean trim_user, int featureType) {
