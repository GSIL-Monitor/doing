...
public abstract class AbsOpenAPI {
     ...
     *            访问令牌
     */
    public AbsOpenAPI(Context context, Oauth2AccessToken accessToken) {
     ...
     *            请求后的回调接口
     */
    protected void requestAsync(String url, WeiboParameters params, String httpMethod,
...
//        AsyncWeiboRunner runner = new AsyncWeiboRunner(appContext);
//        runner.requestAsync(url, params, httpMethod, listener);
        LogUtil.e("share", "request Async in AbsOpenAPI!");
    ...
    protected String requestSync(String url, WeiboParameters params, String httpMethod) {
        ...
        params.put(KEY_ACCESS_TOKEN, mAccessToken.getToken());
//        AsyncWeiboRunner runner = new AsyncWeiboRunner(appContext);
//        return runner.request(url, params, httpMethod);
